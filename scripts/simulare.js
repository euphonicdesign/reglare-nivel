...
function actualizareTabelPozitii(){
  ...
  elementPierderiTotale.style.width = Math.round(dataCumulativToate[selectorZi]/400) + "px";
  ...
  elementPierderiTotaleProiectie.style.width = (Math.round(dataCumulativToate[selectorZi] + 180 * medieCumulativToate[selectorZi])/400) + "px";
...
function desenareRadarModRadar(){
  ...
  if(nrArie!=43){
    ...
    if(vectoriDateZone[nrArie].vectorYAvion[selectorZi]/scalaRadarY + yRadarModRadar> 0 ){
        ...
        //evitare iesire margine - ramas margine
        ctx.arc(vectoriDateZone[nrArie].vectorXAvion[selectorZi] + xRadarModRadar, 0 , dimensiuneAvion*1.3, 0, 2 * Math.PI);
    }
