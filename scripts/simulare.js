...
var xStalpModRadar = xRadarModRadar - razaCerc1 - razaCerc3*3;
...
var rectXModRadar = xRadarModRadar - pistaLungime;
var rectYModRadar = yRadarModRadar - pistaLatime / 2;
    ...
    for(let zona = 0; zona < vectoriDateZone.length; zona++){
      ...
      for(let zi=0; zi<vectoriDateZone[0].date.length; zi++){
          if(zi>(orizont_regresie + orizont_arie)){
              ...
              vectorXAvionZona[zi] = xRadarModRadar + vectoriDateZone[zona].vector_r_normalizat[zi] / scalaPozitieXAvion * (razaCerc1);
              if(nrArie == 43){
                vectorYAvionZona[zi] = yRadarModRadar - vectorMedieZiCurenta[zi] / scalareTraiectorieAvionToate;
              }
              else{
                vectorYAvionZona[zi] = yRadarModRadar - vectorMedieZiCurenta[zi] / scalareTraiectorieAvion ;
              }
          }
      }
...
function desenareRadarModRadar(){
  ...
  //Cerc 1 exterior
  ctx.beginPath();
  ctx.arc(xRadarModRadar, yRadarModRadar, razaCerc1, 0, 2 * Math.PI);
  ctx.closePath();
  ////if(pulsatie)
    ////ctx.stroke();
  ctx.stroke();
  ...
  //ctx.arc(xRadarModRadar, yRadarModRadar, razaCerc1, Math.PI, Math.PI * 3/2);
  ctx.arc(xRadarModRadar, yRadarModRadar, razaCerc1, Math.PI/2, Math.PI);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.beginPath();
  ctx.moveTo(xRadarModRadar,yRadarModRadar);
  ctx.arc(xRadarModRadar, yRadarModRadar, razaCerc1, 0, Math.PI * 1/2);
  ctx.closePath();
  ctx.fill();

  //Cerc 2 mijloc
  ctx.beginPath();
  ctx.arc(xRadarModRadar, yRadarModRadar, razaCerc2, 0, 2 * Math.PI);
  ctx.closePath();
  ////if(pulsatie)
    ////ctx.stroke();
  ctx.stroke();
  ...
  ctx.moveTo(xRadarModRadar - razaCerc1, yRadarModRadar);
  ctx.lineTo(xRadarModRadar + razaCerc1, yRadarModRadar);
  ctx.stroke();

  ctx.moveTo(xRadarModRadar, yRadarModRadar - razaCerc1);
  ctx.lineTo(xRadarModRadar, yRadarModRadar + razaCerc1);
  ctx.stroke();
  ...
  ctx.beginPath();
  ctx.arc(xRadarModRadar, yRadarModRadar, razaCerc3, 0, 2 * Math.PI);
  ctx.closePath();
  ////if(pulsatie)
    ////ctx.stroke();
  ctx.fill();
  ...
  ctx.strokeRect(rectXModRadar+(curbura/2), rectYModRadar+(curbura/2), pistaLungime-curbura, pistaLatime-curbura);
  ctx.fillRect(rectXModRadar+(curbura/2), rectYModRadar+(curbura/2), pistaLungime-curbura, pistaLatime-curbura);

  //ctx.beginPath();
  //ctx.arc(xRadarModRadar - razaCerc1, yRadarModRadar, razaOrigineAeroport, 0, 2 * Math.PI);
  //ctx.closePath();
  //ctx.fill();
  //ctx.stroke();
  ...
  //vectorXAvion[i] = xRadarModRadar + vector_r_normalizat[i] / scalaPozitieXAvion * (razaCerc1);
  //vectorYAvion[i] = yRadarModRadar - vector_valZiCurenta[i] / maxRadarY /*maxValZiCur*/ * (razaCerc1);
  ...
  if(selectorZi > orizont_regresie + orizont_arie){
      ...
      //ctx.fillStyle = "#4d4d4d";
      ctx.beginPath();
      ctx.arc(xStalpModRadar + xsoseta, yStalpModRadar - ysoseta, 4, 0, 2 * Math.PI);
      ctx.closePath();
      ctx.fill();
      ...
      ctx.beginPath();
      ctx.arc(xStalpModRadar, yStalpModRadar, 2, 0, 2 * Math.PI);
      ctx.closePath();
      ctx.fill();
  }
  ...
  ctx.arc(xRadarModRadar, yRadarModRadar, razaCerc1, radianiZi, radianiZi + Math.PI/6);
  ...
  if(vectoriDateZone[nrArie].vectorXAvion[selectorZi]){
      for (let i = (selectorZi - 255); i < selectorZi; i++){
        ...
        ctx.beginPath();
        ctx.arc(vectoriDateZone[nrArie].vectorXAvion[i], vectoriDateZone[nrArie].vectorYAvion[i] , 1 * (1 + 1 * (selectorZi-i)/selectorZi) + 1.0 * (medieCumulativ[i]/scalaDimensiuneAvion), 0, 2 * Math.PI);
        ctx.closePath();
        ctx.fill();
      }
  }
  ...
  if(vectoriDateZone[nrArie].vectorXAvion[selectorZi]){
      if((yRadarModRadar - vectoriDateZone[nrArie].vectorYAvion[selectorZi]) < razaCerc1 && medieCumulativ[selectorZi] < nivelMaxAfisatRezervor){
          cosAvion = (vectoriDateZone[nrArie].vectorXAvion[selectorZi] - xRadarModRadar)/razaCerc1;
          sinAvion = (vectoriDateZone[nrArie].vectorYAvion[selectorZi] - yRadarModRadar)/razaCerc1;
          ...
          if(dist1 < 0.9 && dist2 < 0.8){
              ...
              if(pulsatie_radar == 0){
                  ...
                  pulsatie_radar_x = vectoriDateZone[nrArie].vectorXAvion[selectorZi];
                  pulsatie_radar_y = vectoriDateZone[nrArie].vectorYAvion[selectorZi];
              }
          }
      }
  }
  ...
  if(vectoriDateZone[nrArie].vectorYAvion[selectorZi] > 0 ){
      ctx.arc(vectoriDateZone[nrArie].vectorXAvion[selectorZi], vectoriDateZone[nrArie].vectorYAvion[selectorZi] , dimensiuneAvion, 0, 2 * Math.PI);
  }
  else{
